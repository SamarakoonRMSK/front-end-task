  ...
  return (
    <div className="app_container pt-[40px] pb-[20px] w-full bg-[#4F46E5] xl:h-[266px] flex flex-col gap-10">
      ...
      <div className="flex justify-center  sm:gap-[16px]">
        <div className="">
          <span className="text-white font-inter font-medium xl:text-[14px] leading-[100%] tracking-[0%]">Privacy Policy</span>
        </div>
        <div className="text-white">|</div>
        <div className="">
          <span className="text-white font-inter font-medium xl:text-[14px] leading-[100%] tracking-[0%]">Terms & Conditions</span>
        </div>
      </div>
        </div>
    </div>
